...
public class forumActivity extends AppCompatActivity {
  ...
  private LinearLayoutManager linearLayoutManager;
   ...
   post_author.setText( getIntent().getExtras().getString( "postUsername" ) );
        ...
        collapsingToolbar.setTitle( getIntent().getExtras().getString( "postUsername" ) + "_ის პოსტი" );
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child( "Users" ).child(uid).addListenerForSingleValueEvent( new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                mMap.put("uid",uid);
                                mMap.put("photo",dataSnapshot.child("thumb_image").getValue().toString());
                                ...
                                mMap.put("date", df.format(c.getTime()));

                                mDatabase.push().setValue(mMap);
                                dialog.dismiss();
            ...
            protected void populateViewHolder(final replyViewHolder viewHolder, final postReplyModel model, int position) {
                 ...
                 viewHolder.photo.setOnClickListener( new View.OnClickListener() {
                    ...
                    Intent profileInfo = new Intent( forumActivity.this,ProfileInfoActivity.class );
                         ...
                         System.out.println("aeeeeeeeee" + model.getUsername() + "sdaasdasdasd" + model.getUid());
                     }
                 } );
            }
        };
...
public View mView;
  ...
  public void setPhoto(String photo2) {
      Picasso.with(mView.getContext() ).load( photo2 ).placeholder(R.drawable.white ).into( photo, new Callback() {
          @Override
          public void onSuccess() {
              progressBar.setVisibility( View.GONE);
          }
